...
class GeneratorAdapter extends LocalVariablesSorter {
    ...
    public static ClassWriter addField(int access, String name, String type, String signature, Object value, ClassWriter writer) {
        FieldVisitor visitor = writer.visitField(access, name, type, signature, value);
        visitor.visitEnd();
        return writer;
    }
    ...
    public static GeneratorAdapter newMethodGenerator(ClassWriter writer, String name, String descriptor, String... throwables) {
    	return newMethodGenerator(ACC_PUBLIC, writer, name, descriptor, throwables);
    }
    
    public static GeneratorAdapter newMethodGenerator(int access, ClassWriter writer, String name, String descriptor, String... throwables) {
        return new GeneratorAdapter(writer.visitMethod(access, name, descriptor, null, throwables), access, name, descriptor);
    }
...
//    methodVisitor.visitLocalVariable("this", "Lme/acablade/nmsasm/NMSAsm;", null, label0, label3, 0);
//    methodVisitor.visitLocalVariable("handle", "Ljava/lang/Object;", null, label0, label3, 1);
//    methodVisitor.visitMaxs(2, 2);
//    methodVisitor.visitEnd();
    
    public static void writeConstructor(Class<?> clazz, ClassWriter writer) {
        GeneratorAdapter adapter = newMethodGenerator(writer, "<init>", "(Ljava/lang/Object;)V");
//        Label label1 = adapter.mark();
        adapter.loadThis();
        adapter.invokeConstructor(OBJECT_TYPE, DEFAULT_CONSTRUCTOR);
        adapter.loadThis();
        adapter.loadArg(0);
        adapter.visitFieldInsn(Opcodes.PUTFIELD, Type.getInternalName(clazz) + "$NMSImpl", "handle", "Ljava/lang/Object;");
        adapter.visitInsn(Opcodes.RETURN);
//        Label label2 = adapter.mark();
//        adapter.visitLocalVariable("this", Type.getDescriptor(clazz), null, label1, label2, 0);
//        adapter.visitLocalVariable("handle", "Ljava/lang/Object;", null, label1, label2, 1);
        adapter.endMethod();
    }
    
    public static void writeEmptyConstructor(Class<?> clazz, ClassWriter writer) {
